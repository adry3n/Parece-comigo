...
#define SPRITE_SIZE 47                     // Tamanho (largura e altura) de cada frame do sprite
#define SPRITE_COLS 3                      // Número de colunas na spritesheet
...
int main() {
    ...
    ALLEGRO_BITMAP *sprite_sheet = al_load_bitmap("../../sprites/teste.png");
